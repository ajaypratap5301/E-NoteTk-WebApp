	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link" href="addNotes.jsp"><i
					class="fa fa-plus-circle" aria-hidden="true"></i></i>Add Notes</a></li>
		...
		<a href="login.jsp" class="btn btn-light my-2 my-sm-0 mr-3"
			data-toggle="modal" data-target="#exampleModalLong" type="submit"><i
			class="fa fa-sign-in" aria-hidden="true"></i><%=user.getName()%></a>
